...
func hello(res http.ResponseWriter, req *http.Request) {
  ...
  <a href='#' onCLick ="var json = {}; json.type = 'username'; json.name= $('#username').val(); websocket.send(JSON.stringify(json)); $('#user-form').hide(); $('#enter-data').show(); window.location.reload();">Update Name</a>
  </div>
  `
